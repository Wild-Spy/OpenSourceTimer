...
public final class UByte extends UNumber implements Comparable<UByte> {
    ...
    public UByte lsl(final UByte val) {
        return valueOf(value << val.value);
    }

    public UByte lsl(final int val) {
        return valueOf(value << val);
    }

    public UByte lsr(final UByte val) {
        return valueOf(value >> val.value);
    }

    public UByte lsr(final int val) {
        return valueOf(value >> val);
    }

    public UByte bitwise_or(final UByte val) {
        return valueOf(value | val.value);
    }

    public UByte bitwise_or(final int val) {
        return valueOf(value | val);
    }

    public UByte bitwise_and(final UByte val) {
        return valueOf(value & val.value);
    }

    public UByte bitwise_and(final int val) {
        return valueOf(value & val);
    }

    public UByte bitwise_xor(final UByte val) {
        return valueOf(value ^ val.value);
    }

    public UByte bitwise_xor(final int val) {
        return valueOf(value ^ val);
    }
}
